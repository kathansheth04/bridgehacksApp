    ...
    constructor(props) {
      ...
      getImage(props) {
        ...
        if(parseInt(indexNum, 10)%8 === 0) {
          ...
          return <Image style={styles.gridItemImage}source={require('./assets/foods/salads/salad2.jpg')}/>
        } else if(parseInt(indexNum, 10)%3 === 0) {
          return <Image style={styles.gridItemImage}source={require('./assets/foods/salads/salad3.jpg')}/>
        } else if(parseInt(indexNum, 10)%7 === 0) {
          return <Image style={styles.gridItemImage}source={require('./assets/foods/salads/salad4.jpg')}/>
        } else if(parseInt(indexNum, 10)%2 === 0) {
          return <Image style={styles.gridItemImage}source={require('./assets/salad.jpg')}/>
        } else {
          return <Image style={styles.gridItemImage}source={require('./assets/foods/salads/salad5.jpg')}/>
        }
      }
      componentDidMount() {
            return fetch('http://webknox.com/api/recipes/search?type=salad&number=10000&apiKey=c9f71a6be7174d85ae404ae2a9cb7e39')
