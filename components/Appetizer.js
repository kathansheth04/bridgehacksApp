    ...
    constructor(props) {
      ...
      getImage(props) {
        ...
        if(parseInt(indexNum, 10)%8 === 0) {
          return <Image style={styles.gridItemImage}source={require('./assets/foods/appetizers/appetizer5.jpg')}/>
          ...
          return <Image style={styles.gridItemImage}source={require('./assets/foods/appetizers/appetizer3.jpg')}/>
        } else if(parseInt(indexNum, 10)%7 === 0) {
          return <Image style={styles.gridItemImage}source={require('./assets/foods/appetizers/appetizer2.jpg')}/>
        } else if(parseInt(indexNum, 10)%2 === 0) {
          return <Image style={styles.gridItemImage}source={require('./assets/appetizer.jpg')}/>
        } else {
          return <Image style={styles.gridItemImage}source={require('./assets/foods/appetizers/appetizer1.jpg')}/>
        }
      }
      componentDidMount() {
            return fetch('http://webknox.com/api/recipes/search?type=appetizer&number=10000&apiKey=c9f71a6be7174d85ae404ae2a9cb7e39')
